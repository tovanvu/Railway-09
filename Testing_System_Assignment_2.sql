...
VALUE ( 'Group_name11', '1', '2020-04-01'),
      ( 'Group_name12', '2', '2020-04-02'),
      ( 'Group_name13', '3', '2020-04-03'),
      ( 'Group_name14', '4', '2020-04-04'),
      ( 'Group_name15', '5', '2020-04-05');
INSERT INTO Group_Account (Group_ID, Account_ID, Join_date)
VALUE ('3', '1', '2020-05-01'),
      ('2', '2', '2020-05-02'),
      ('5', '3', '2020-05-08'),
      ('1', '4', '2020-05-09'),
      ('4', '5', '2020-05-04');
...
VALUE ('CODE01', 'Title1', '1', '60', '3'),
	  ('CODE02', 'Title2', '2', '90', '2'),
      ('CODE03', 'Title3', '3', '90', '4'),
      ('CODE04', 'Title4', '4', '60', '5'),
      ('CODE05', 'Title5', '5', '90', '1');
